...
// 					for (int i=0; i<runs; i++) {
						...
						try ( DataOutputStream out =
							new DataOutputStream(new BufferedOutputStream(new FileOutputStream("src/../"+datFile))) ) {
...
// 							BufferedReader br = new BufferedReader(in); 
							if (in.available()>1) {
								System.out.println("Data File Loaded: " + fileName);
							} else {System.out.println("Unable to Load Data File.");}
